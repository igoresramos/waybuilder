...
| `wb:weapon/alchemical-bomb` | Alchemical Bomb | weapon | aon | weapon_category, group |
| `wb:weapon/axe-musket-melee` | Axe Musket (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/axe-musket-ranged` | Axe Musket (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/black-powder-knuckle-dusters-melee` | Black Powder Knuckle Dusters (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/black-powder-knuckle-dusters-ranged` | Black Powder Knuckle Dusters (Ranged) | weapon | aon | damage, weapon_category, group |
...
| `wb:weapon/bolts-phalanx-piercer` | Bolts (Phalanx Piercer) | weapon | aon | weapon_category, group |
| `wb:weapon/bow-staff-melee` | Bow Staff (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/bow-staff-ranged` | Bow Staff (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/butterfly-sword-nv0` | Butterfly Sword | weapon | foundry | damage, weapon_category, group |
| `wb:weapon/cane-pistol-melee` | Cane Pistol (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/cane-pistol-ranged` | Cane Pistol (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/chakri-recovery` | Chakri | weapon | foundry | damage, weapon_category, group |
| `wb:weapon/crescent-cross-melee` | Crescent Cross (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/crescent-cross-ranged` | Crescent Cross (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/dagger-pistol-melee` | Dagger Pistol (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/dagger-pistol-ranged` | Dagger Pistol (Ranged) | weapon | aon | damage, weapon_category, group |
...
| `wb:weapon/explosive-dogslicer-melee` | Explosive Dogslicer (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/explosive-dogslicer-ranged` | Explosive Dogslicer (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/firearm-ammunition-10-rounds` | Firearm Ammunition (10 rounds) | weapon | aon | weapon_category, group |
| `wb:weapon/firearm-ammunition-5-rounds` | Firearm Ammunition (5 rounds) | weapon | aon | weapon_category, group |
| `wb:weapon/fist` | Fist | weapon | aon | damage, weapon_category, group |
| `wb:weapon/gnome-amalgam-musket-melee` | Gnome Amalgam Musket (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/gnome-amalgam-musket-ranged` | Gnome Amalgam Musket (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/gun-sword-melee` | Gun Sword (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/gun-sword-ranged` | Gun Sword (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/hammer-gun-melee` | Hammer Gun (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/hammer-gun-ranged` | Hammer Gun (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/jiu-huan-dao-disarm` | Jiu Huan Dao | weapon | foundry | damage, weapon_category, group |
| `wb:weapon/khakkara` | Khakkara | weapon | aon | damage, weapon_category, group |
| `wb:weapon/kursarigama` | Kursarigama | weapon | aon | damage, weapon_category, group |
| `wb:weapon/lancer-melee` | Lancer (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/lancer-ranged` | Lancer (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/mace-multipistol-melee` | Mace Multipistol (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/mace-multipistol-ranged` | Mace Multipistol (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/magazine-air-repeater` | Magazine (Air Repeater) | weapon | aon | weapon_category, group |
| `wb:weapon/magazine-long-air-repeater` | Magazine (Long Air Repeater) | weapon | aon | weapon_category, group |
| `wb:weapon/mikazuki-melee` | Mikazuki (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/mikazuki-ranged` | Mikazuki (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/mithral-tree` | Mithral Tree | weapon | aon | damage, weapon_category, group |
| `wb:weapon/piercing-wind-melee` | Piercing Wind (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/piercing-wind-ranged` | Piercing Wind (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/rapier-pistol-melee` | Rapier Pistol (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/rapier-pistol-ranged` | Rapier Pistol (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/reinforced-frame` | Reinforced Frame | weapon | aon | damage, weapon_category, group |
...
| `wb:weapon/rungu` | Rungu | weapon | aon | damage, weapon_category, group |
| `wb:weapon/shield-bash` | Shield Bash | weapon | aon | damage, weapon_category, group |
| `wb:weapon/spray-pellet` | Spray Pellet | weapon | aon | weapon_category, group |
| `wb:weapon/tekko-kagi-trip` | Tekko-kagi | weapon | foundry | damage, weapon_category, group |
| `wb:weapon/three-peaked-tree-melee` | Three Peaked Tree (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/three-peaked-tree-ranged` | Three Peaked Tree (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/triggerbrand-melee` | Triggerbrand (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/triggerbrand-ranged` | Triggerbrand (Ranged) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/wrecker-melee` | Wrecker (Melee) | weapon | aon | damage, weapon_category, group |
| `wb:weapon/wrecker-ranged` | Wrecker (Ranged) | weapon | aon | damage, weapon_category, group |
