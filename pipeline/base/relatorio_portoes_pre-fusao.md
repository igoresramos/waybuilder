...
- **COLISAO** `wb:feat/spell-mastery` casou com `feat-5055` mas o AoN tem 2 entidades: feat-1169(nv20,Uncommon,Wizard); feat-5055(nv20,Wizard)
...
- **COLISAO** `wb:feat/tusks` casou com `feat-4519` mas o AoN tem 2 entidades: feat-963(nv1,Half-Orc,Dromaar); feat-4519(nv1,Orc)
- **COLISAO** `wb:feat/ultimate-flexibility` casou com `feat-4858` mas o AoN tem 2 entidades: feat-1171(nv20,Fighter,Uncommon); feat-4858(nv20,Fighter)
- **COLISAO** `wb:feat/unstoppable-juggernaut` casou com `feat-5880` mas o AoN tem 2 entidades: feat-1167(nv20,Barbarian,Uncommon); feat-5880(nv20,Barbarian)
- **COLISAO** `wb:archetype/bright-lion` casou com `archetype-129` mas o AoN tem 2 entidades: archetype-83(nvNone,); archetype-129(nv2,Uncommon)
- **COLISAO** `wb:spell/object-reading` casou com `spell-2012` mas o AoN tem 2 entidades: spell-553(nv1,Divination,Uncommon); spell-2012(nv1,Concentrate,Manipulate)
...
- **COLISAO** `wb:spell/practice-makes-perfect` casou com `spell-2417` mas o AoN tem 2 entidades: spell-559(nv1,Cleric,Divination,Uncommon,F); spell-2417(nv1,Cleric,Focus,Manipulate,Unco)
...
- **COLISAO** `wb:spell/tireless-worker` casou com `spell-2418` mas o AoN tem 2 entidades: spell-560(nv4,Healing,Necromancy,Focus); spell-2418(nv4,Cleric,Concentrate,Focus,Hea)
...
- **COLISAO** `wb:spell/chilling-spray` casou com `spell-1975` mas o AoN tem 2 entidades: spell-571(nv1,Cold,Evocation); spell-1975(nv1,Cold,Concentrate,Manipulate)
...
- **COLISAO** `wb:spell/fearful-feast` casou com `spell-2376` mas o AoN tem 2 entidades: spell-843(nv4,Fear,Mental,Necromancy,Uncom); spell-2376(nv4,Cleric,Fear,Focus,Manipulate)
- **COLISAO** `wb:spell/ill-omen` casou com `spell-1566` mas o AoN tem 2 entidades: spell-578(nv1,Curse,Divination,Misfortune); spell-1566(nv1,Concentrate,Curse,Manipulate)
- **COLISAO** `wb:spell/imprint-message` casou com `spell-2003` mas o AoN tem 2 entidades: spell-551(nv1,Divination,Uncommon); spell-2003(nv1,Concentrate,Manipulate)
- **COLISAO** `wb:equipment/acid-flask` casou com `equipment-3286` mas o AoN tem 2 entidades: equipment-2875(nv0,Acid,Alchemical,Bomb,Consuma); equipment-3286(nv1,Acid,Alchemical,Bomb,Consuma)
...
- **COLISAO** `wb:equipment/alchemists-fire` casou com `equipment-3287` mas o AoN tem 2 entidades: equipment-2876(nv0,Alchemical,Bomb,Consumable,F); equipment-3287(nv1,Alchemical,Bomb,Consumable,F)
- **COLISAO** `wb:equipment/antidote` casou com `equipment-3296` mas o AoN tem 2 entidades: equipment-2879(nv0,Alchemical,Consumable,Elixir); equipment-3296(nv1,Alchemical,Consumable,Elixir)
- **COLISAO** `wb:equipment/antiplague` casou com `equipment-3297` mas o AoN tem 2 entidades: equipment-2880(nv0,Alchemical,Consumable,Elixir); equipment-3297(nv1,Alchemical,Consumable,Elixir)
- **COLISAO** `wb:equipment/bellflower-toolbelt` casou com `equipment-2308` mas o AoN tem 2 entidades: equipment-505(nv6,Invested,Magical,Rare,Transm); equipment-2308(nv6,Invested,Magical,Rare)
- **COLISAO** `wb:equipment/bombers-eye-elixir` casou com `equipment-3298` mas o AoN tem 2 entidades: equipment-2881(nv0,Alchemical,Consumable,Elixir); equipment-3298(nv4,Alchemical,Consumable,Elixir)
- **COLISAO** `wb:equipment/bravos-brew` casou com `equipment-3300` mas o AoN tem 2 entidades: equipment-2882(nv0,Alchemical,Consumable,Elixir); equipment-3300(nv2,Alchemical,Consumable,Elixir)
- **COLISAO** `wb:equipment/candlecap` casou com `equipment-2332` mas o AoN tem 2 entidades: equipment-1503(nv1,Evocation,Invested,Magical,U); equipment-2332(nv1,Invested,Light,Magical)
- **COLISAO** `wb:equipment/cheetahs-elixir` casou com `equipment-3302` mas o AoN tem 2 entidades: equipment-2884(nv0,Alchemical,Consumable,Elixir); equipment-3302(nv1,Alchemical,Consumable,Elixir)
- **COLISAO** `wb:equipment/corpseward-pendant` casou com `equipment-2341` mas o AoN tem 2 entidades: equipment-806(nv5,Abjuration,Invested,Magical,); equipment-2341(nv5,Invested,Magical,Uncommon)
- **COLISAO** `wb:equipment/crown-of-the-companion` casou com `equipment-2334` mas o AoN tem 2 entidades: equipment-1086(nv6,Healing,Invested,Magical,Nec); equipment-2334(nv6,Healing,Invested,Magical,Unc)
